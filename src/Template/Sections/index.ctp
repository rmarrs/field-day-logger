...
<div class="sections index large-9 medium-8 columns content">
    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                <th scope="col"><?= $this->Paginator->sort('abbr') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $section->abbr]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $section->abbr]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $section->abbr], ['confirm' => __('Are you sure you want to delete # {0}?', $section->abbr)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
